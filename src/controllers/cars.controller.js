...
class CarsController {
    ...
    async createCar(req, res){
        try{
            ...
            const car = new Car(payload?.nombre, payload?.cedula, payload?.numero, payload?.correo, payload?.direccion, payload?.modelo, payload?.marca, payload?.placa, payload?.descripcion  )
            car.valid();
